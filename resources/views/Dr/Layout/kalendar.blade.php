...
<div class="row">
  ...
  <div class="col-md-2 col-xs-2">
      <button class="btn btn-success" onclick=location.href="{{ url('/MainDr')}}/{{$back[0]}}/{{$back[1]}}/1/wstecz">Miesiąc Wstecz</button>
  </div>
  <div class="col-md-2 col-xs-2">
          <button class="btn btn-success" onclick=location.href="{{ url('/MainDr')}}/{{$back_year[0]}}/{{$back_year[1]}}/1/wstecz">Rok Wstecz</button>
  </div>
  <div class="col-md-2 col-xs-2">
      <button class="btn btn-success" onclick=location.href="{{ url('/MainDr')}}/{{$next_year[0]}}/{{$next_year[1]}}/1/wstecz">Rok Dalej</button>
      
  </div>
  <div class="col-md-2 col-xs-2">
      <button class="btn btn-success" onclick=location.href="{{ url('/MainDr')}}/{{$next[0]}}/{{$next[1]}}/1/wstecz">miesiąc Dalej</button>
